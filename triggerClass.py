...
class cmc:
    ...
    def __init__(self, gainTrigger, loseTrigger, sendNotifications, moveHistoryCsv, delay):
    ...
    def buyToken(self, token="0x6615a63c260be84974166a5eddff223ce292cf3d"):
        ...
        now = time.ctime(int(time.time()) + 30000)
        print("the now time is " + str(now))
    ...
    def sellToken(self):
        ...
        sender_address = '' #TokenAddress of holder
        ...
        #Setup the PancakeSwap contract
        contract = web3.eth.contract(address=self.panRouterContractAddress, abi=panabi)
